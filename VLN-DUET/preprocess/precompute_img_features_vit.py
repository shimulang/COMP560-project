...
if __name__ == '__main__':
    ...
    parser.add_argument('--connectivity_dir', default='/root/autodl-tmp/VLN/VLN-DUET/datasets/R2R/connectivity')
    parser.add_argument('--scan_dir', default='/root/autodl-tmp/VLN/datasets/v1/mp3d')
    parser.add_argument('--out_image_logits', action='store_true', default=False)
    parser.add_argument('--output_file',default="/root/autodl-tmp/VLN/VLN-DUET/datasets/R2R")
