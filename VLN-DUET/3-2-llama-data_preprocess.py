...
anno_files = ["/root/vln/VLN-DUET/datasets/R2R/annotations/FGR2R_pretrain/train_llama3_70B_fineturn_generate_instructions_sub_instruction_clean.jsonl"]
...
for anno_file in anno_files:
    ...
    with jsonlines.open(anno_file, 'r') as f:
        ...
        # 保存到新的jsonl文件中
    with jsonlines.open("datasets/R2R/annotations/pretrain/train_openai_llama3_generate_instructionsv7.jsonl", 'w') as f:
